...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accimage: Schema.Attribute.Media<'images' | 'files' | 'videos'> &
    ...
    actimage: Schema.Attribute.Media<'images' | 'files' | 'videos'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experiences: Schema.Attribute.Component<'experiences.experience', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    intimage: Schema.Attribute.Media<'images' | 'files' | 'videos'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    recimage: Schema.Attribute.Media<'images' | 'files' | 'videos'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiExperienceCategoryExperienceCategory
  ...
  attributes: {
    ...
    profile: Schema.Attribute.Enumeration<
      ['lifestyle', 'perfil', 'profile', 'temporada', 'season']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTopDestinationTopDestination
  extends Struct.CollectionTypeSchema {
  collectionName: 'top_destinations';
  info: {
    description: '';
    displayName: 'top destination';
    pluralName: 'top-destinations';
    singularName: 'top-destination';
  };
  options: {
    draftAndPublish: true;
  };
